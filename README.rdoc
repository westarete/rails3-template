...
(2) Rename the project to your new project name and clone it to your local
    machine.
(3) Do a global find/replace in the project for "PROJECT" and replace it with
    the short name of your project (the basename for the github project, 
    preferrably). For example, "blog".
